...
func scripts_alert_applescript() (*asset, error) {
	...
	info := bindata_file_info{name: "scripts/alert.applescript", size: 223, mode: os.FileMode(420), modTime: time.Unix(1468181132, 0)}
...
func scripts_brightness_applescript() (*asset, error) {
	...
	info := bindata_file_info{name: "scripts/brightness.applescript", size: 419, mode: os.FileMode(420), modTime: time.Unix(1468181155, 0)}
	a := &asset{bytes: bytes, info:  info}
	return a, nil
}
