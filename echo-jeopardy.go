...
func jeopardyCategory(echoReq *alexa.EchoRequest, session *JeopardySession) (*alexa.EchoResponse, *JeopardySession) {
	...
	msg += "From " + category + " for " + strconv.Itoa(clue.Value) + ". " + clue.Question + ". Do do do, do da do do do. Do da do da do; da do da do da. Do da do, do da do da do; do, da do do do do do. I need your answer!"
	...
	echoResp := alexa.NewEchoResponse().OutputSpeech(msg).Card("Question", msg).EndSession(false)
...
func jeopardyAnswer(echoReq *alexa.EchoRequest, session *JeopardySession) (*alexa.EchoResponse, *JeopardySession) {
	...
	msg += "You're at " + strconv.Itoa(session.Dollars) + " after " + strconv.Itoa(session.NumQuestions) + " questions."
